...
Item Descrição Plataforma X (Twitter) Hashtag monitorada #QuemAmaCuida Período de coleta18/05/2026, 21h20–22h10 (horário de Brasília)Total de publicações 7.207 tweetsIdioma predominante Português brasileiro
...
├── 🐍 analise_sentimentos.py       — script principal de limpeza e análise de sentimento
...
bashpython analise_sentimentos.py
...
Este repositório está disponível sob a licença Creative Commons Attribution 4.0 International (CC BY 4.0). Você pode usar, adaptar e redistribuir o conteúdo desde que cite a autora.
